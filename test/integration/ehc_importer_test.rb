...
class EhcImporterTest < ActiveSupport::TestCase
  ...
  test 'handle missing EHC content' do
    with_versioning do
      ...
      artifact = artifacts.where(remote_identifier: 'http://example.com/1')
      assert(artifact.present?)
